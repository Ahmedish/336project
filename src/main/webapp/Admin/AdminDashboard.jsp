...
<a class="btn btn-primary" href="<%=projectName%>/Admin/SalesReport.jsp">View Sales Report</a>
<a class="btn btn-success" href="<%=projectName%>/Admin/CreateCustomerRep.jsp">Create Customer Rep</a>
